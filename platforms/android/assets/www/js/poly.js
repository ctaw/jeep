...
function initialize() {
  var center = new google.maps.LatLng(14.6090537, 121.02225650000003);
  ...
  var request = { 
    origin: "R. Papa Station, Ricardo Papa Street, Manila, Metro Manila, Philippines", 
    destination: "2nd Avenue, Caloocan, Metro Manila, Philippines", 
...
var icons = new Array();
icons["red"] = new google.maps.MarkerImage("img/marker_red.png",
...
function getMarkerImage(iconColor) {
   ...
   if (!icons[iconColor]) {
      icons[iconColor] = new google.maps.MarkerImage("img/marker_"+ iconColor +".png",
      // This marker is 20 pixels wide by 34 pixels tall.
      new google.maps.Size(20, 34),
      // The origin for this image is 0,0.
      new google.maps.Point(0,0),
  ...
  var iconImage = new google.maps.MarkerImage('img/marker_red.png',
      // This marker is 20 pixels wide by 34 pixels tall.
      new google.maps.Size(20, 34),
      // The origin for this image is 0,0.
      new google.maps.Point(0,0),
